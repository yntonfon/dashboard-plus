...
class TestAccountDatabaseProvider(UnitTest):
    def setup_method(self):
        self.mock_session = mock.create_autospec(Session)
        self.provider = AccountDataProvider(self.mock_session)
    ...
    def test_insert_should_add_an_account_object_to_session(self):
        ...
        # Then
        mapper = self.mock_session.add.call_args[0][0]
    ...
    def test_insert_should_raise_when_duplicate_records_is_found(self):
        # Given
        self.mock_session.commit.side_effect = IntegrityError(None, None, None)
    ...
    def test_insert_should_raise_when_unexpected_error_occured(self):
        ...
        self.mock_session.commit.side_effect = sql_error
